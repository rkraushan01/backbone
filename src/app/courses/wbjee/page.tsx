        ...
        <div className="bg-black text-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 mt-36">
            ...
            <p className="mt-1 max-w-2xl text-sm text-white text-left">
              ...
              <br />
              To uphold our commitment to students' engineering journey, PointerZone vigilantly tracks changes in WBJEE counseling, encompassing private colleges. Renowned institutions like Jadavpur University and Maulana Abul Kalam Azad University of Technology are pivotal in this process. Remaining updated enables us to offer precise guidance tailored to each college's admission criteria. Through personalized support, we empower students to navigate the admission process seamlessly and make informed decisions about their academic future.
