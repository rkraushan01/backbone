        ...
        <div className="bg-black text-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 mt-36">
            ...
            <p className="mt-1 max-w-2xl text-sm text-white text-left">
              ...
              <br />
              In the dynamic realm of engineering admissions, PointerZone stands
              as a steadfast ally to students. Staying up-to-date with changes
              in the UPTU and UPSEE counseling process, inclusive of private
              colleges, is paramount for us. It underscores our unwavering
              commitment to students' academic journeys. With renowned
              institutions like SRM Institute of Science and Technology, Amity
              University, and Galgotias University in the mix, staying informed
              is non-negotiable. We meticulously track changes to provide
              accurate guidance tailored to each college's requirements. By
              empowering students with this knowledge, we enable them to
              navigate the admission process wisely, ensuring a promising
              academic future. At PointerZone, our personalized support
              amplifies students' chances of securing admission to their desired
              engineering colleges through UPTU, UPSEE, or direct admission to
