        ...
        <div className="bg-black text-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 mt-36">
            ...
            <p className="mt-1 max-w-2xl text-sm text-white text-left">
              ...
              <br />
              In the ever-evolving landscape of engineering admissions,
              PointerZone remains steadfast in its mission to guide students
              toward success. Adapting to changes in JAC Delhi counseling is a
              priority and a testament to our dedication to student excellence.
              With esteemed institutions like DTU, NSIT, IIT Delhi, and IGDTUW
              in the mix, staying updated is paramount. It enables us to provide
              precise guidance tailored to each institution, empowering students
              to navigate the complex admission process confidently. At
              PointerZone, our personalized support ensures every student has
              the best chance to secure admission to their preferred engineering
              colleges in Delhi.
            </p>
          </div>
